\chapter{Wave Estimating Algorithm for Vessels Experiment (WEAVE)}
...
% !https://user-images.githubusercontent.com/8077426/244510835-9e355498-dd3a-4c37-a63c-776719ef89bc.PNG

% !https://user-images.githubusercontent.com/8077426/244510841-f2535bc3-1237-4d3c-beff-73ea63e68ed0.PNG

% !https://user-images.githubusercontent.com/8077426/244510844-809ae599-16b9-4f2f-935c-8e865a0e95e7.PNG
...
%     \EndProcedure
    % \end{algorithmic}
% Function: wave_by_wave
% Arguments: eta, f_s, g
% Returns: upcross_times, waves
%   index := 1
%   Find all indicies where eta is negative
%   For each negative index:
%     If the next index in eta is positive:
%       Add the current negative index to upcross_times
%       Increment index
%     end
%   end

%   For each upcross_time except the last one:s
%     Calculate wave waves inside a wave structure
%     Append new wave struct to waves
%   end
% end
% \end{algorithmic}
...
% \begin{algorithm}
%     \KwIn{$\eta, f_s, g$}
%     \KwOut{upcross_times, waves}
%     \caption{Wave by Wave algorithm}\label{alg:wave_by_wave}                        
% \end{algorithm}
...
\begin{algorithm}
    \begin{algorithmic}[1]
        ...
        \For{$n=1, \dots, \text{size}(\text{negIndices})$}
