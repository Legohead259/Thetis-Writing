...
\begin{figure}[h!]
    \centering
    \subfloat[Start: $\lbrack 0, 0, 0\rbrack$]{\includegraphics[width=0.25\textwidth]{background/ship_000000}\label{subfig:ship_000000}}\hskip3ex
    \subfloat[$\lbrack 0, 90, 0 \rbrack$]{\includegraphics[height=1in]{background/ship_009000}\label{subfig:ship_009000}}\hskip10ex
    \subfloat[$\lbrack 90, 90, 0 \rbrack$]{\includegraphics[height=1in]{background/ship_909000}\label{subfig:ship_909000}}\hskip5ex
    \subfloat[End: $\lbrack 0, 0, 90 \rbrack$]{\includegraphics[width=0.25\textwidth]{background/ship_000090}\label{subfig:ship_000090}}
    \subfloat[Desired: $\lbrack 90, 0, 0 \rbrack$]{\includegraphics[width=0.25\textwidth]{background/ship_900000}\label{subfig:ship_900000}}
...
\begin{figure}
    ...
    \includegraphics[height=1.5in]{background/navx2_micro.png}
    \labfig{navx2_micro}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[height=1.5in]{background/sparkfun_ola.png}
    \labfig{sparkfun_ola}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[height=1.5in]{background/pixhawk_6x.png}
    \labfig{pixhawk_6x}
\end{figure}