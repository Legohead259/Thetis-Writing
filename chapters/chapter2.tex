...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[height=1.3in]{ahrs.png}
\end{figure}
...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[height=2.5in]{body_rotations.png}
\end{figure}
...
\begin{figure}
    \begin{fitbox}[frametitle=Aside: Gimbal Lock]
        ...
        \begin{center}
            \subfloat[Start: $\langle0, 0, 0\rangle$]{\includegraphics[width=0.25\textwidth]{ship_000000}\label{subfig:ship_000000}}\hskip3ex
            \subfloat[$\langle0, 90, 0\rangle$]{\includegraphics[height=1in]{ship_009000}\label{subfig:ship_009000}}\hskip10ex
            \subfloat[$\langle90, 90, 0\rangle$]{\includegraphics[height=1in]{ship_909000}\label{subfig:ship_909000}}\hskip5ex
            \subfloat[End: $\langle0, 0, 90\rangle$]{\includegraphics[width=0.25\textwidth]{ship_000090}\label{subfig:ship_000090}}
...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[width=6in]{KalmanFilter.png}
\end{figure}
