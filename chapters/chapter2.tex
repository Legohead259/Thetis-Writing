...
\begin{figure}[h!]
    \centering
    \subfloat[Start: $\langle0, 0, 0\rangle$]{\includegraphics[width=0.25\textwidth]{background/ship_000000}\labsubfig{ship_000000}}\hskip3ex
    \subfloat[$\langle0, 90, 0\rangle$]{\includegraphics[height=1in]{background/ship_009000}\labsubfig{ship_009000}}\hskip10ex
    \subfloat[$\langle90, 90, 0\rangle$]{\includegraphics[height=1in]{background/ship_909000}\labsubfig{ship_909000}}\hskip5ex
    \subfloat[End: $\langle0, 0, 90\rangle$]{\includegraphics[width=0.25\textwidth]{background/ship_000090}\labsubfig{ship_000090}}
    \subfloat[Desired: $\langle90, 0, 0\rangle$]{\includegraphics[width=0.25\textwidth]{background/ship_900000}\labsubfig{ship_900000}}
...
\begin{equation} \labeq{sensitivity_and_misalignment}
    S = \text{diag}(M^*) \\
    M = M^* \cdot S^{-1}
\end{equation}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/sparton_ahrs8.png}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/xsens_mti100.png}
    \labfig{xsens_mti100}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/vn200.png}
    \labfig{vn200}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/swiftnav_duro.png}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/aceinna_ins401.png}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/navx2_micro.png}
    \labfig{navx2_micro}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/sparkfun_ola.png}
    \labfig{sparkfun_ola}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/pixhawk_6x.png}
    \labfig{pixhawk_6x}
\end{figure}
...
\begin{figure}
    ...
    \includegraphics[width=3in]{background/ximu3.png}
    \labfig{ximu3}
\end{figure}