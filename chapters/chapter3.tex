...
\begin{figure}[h!]
    \centering
    \subfloat[Thetis placed into a jig, ready to put under the stencil.]{\includegraphics[height=1in]{design/assembly_jig}\labsubfig{assembly_jig}}\hskip3ex
    \subfloat[Depositing the solder on the stencil and dragging it across.]{\includegraphics[height=1in]{design/assembly_paste.jpg}\labsubfig{assembly_paste}}\hskip10ex
    \subfloat[Solder deposited on the PCB pads from the stencil]{\includegraphics[height=1in]{design/assembly_pasted.jpg}\labsubfig{assembly_pasted}}\hskip5ex
...
\begin{figure}[h!]
    \centering
    \subfloat[Components being placed from inventory boxes onto the boards manually using tweezers]{\includegraphics[height=1in]{design/assembly_placing_components}\labsubfig{assembly_placing}}\hskip3ex
    \subfloat[All in-stock components placed on the PCB.]{\includegraphics[height=1in]{design/assembly_placed_components.jpg}\labsubfig{assembly_placed}}\hskip10ex
    \subfloat[PCB on a mini hotplate for solder reflow.]{\includegraphics[height=1in]{design/assembly_reflow.jpg}\labsubfig{assembly_reflow}}\hskip5ex
