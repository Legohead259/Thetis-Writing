...
\begin{figure}[h!]
	\centering
	\includegraphics[width=5in]{design/tht_vs_smd.jpg}
...
\begin{figure}[h!]
    \centering
    \subfloat[Thetis placed into a jig, ready to put under the stencil.]{\includegraphics[height=1in]{design/assembly_jig}\label{subfig:assembly_jig}}\hskip3ex
    \subfloat[Depositing the solder on the stencil and dragging it across.]{\includegraphics[height=1in]{design/assembly_paste.jpg}\label{subfig:assembly_paste}}\hskip10ex
    \subfloat[Solder deposited on the PCB pads from the stencil]{\includegraphics[height=1in]{design/assembly_pasted.jpg}\label{subfig:assembly_pasted}}\hskip5ex
...
\begin{figure}[h!]
    \centering
    \subfloat[Components being placed from inventory boxes onto the boards manually using tweezers]{\includegraphics[height=1in]{design/assembly_placing_components}\label{subfig:assembly_placing}}\hskip3ex
    \subfloat[All in-stock components placed on the PCB.]{\includegraphics[height=1in]{design/assembly_placed_components.jpg}\label{subfig:assembly_placed}}\hskip10ex
    \subfloat[PCB on a mini hotplate for solder reflow.]{\includegraphics[height=1in]{design/assembly_reflow.jpg}\label{subfig:assembly_reflow}}\hskip5ex
	\caption[Component placement and reflow for a Thetis Revision F5 PCB]{A series showing the process of components onto a Revision F5 PCB from an inventory and using a hotplate for solder reflow.}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=5in]{design/assembly_inspection.jpg}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=5in]{design/assembly_testing.jpg}
