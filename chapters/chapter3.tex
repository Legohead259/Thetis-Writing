...
\begin{landscape}
	\begin{table}
		\caption[Failure Mode, Effect, and Criticality Analysis]{A summary of all possible failure modes and their expected effects, likelihoods, criticalities, and mitigations on the Thetis system.}
		\label{tab:fmeca}
		\centering
		\includegraphics[height=6.75in]{../include/ThetisFMECA.pdf}
	\end{table}
\end{landscape}
