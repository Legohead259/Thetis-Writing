...
\begin{table}[ht!]
	...
	\begin{tabular}{| c | m{0.55\textwidth} | c | c | c |}
		...
		104 & The system shall be able to record inertial measurements of at least 64 Hz & 1 & 10 & TIP \\
		...
		111 & The operator shall be able to load data off the system & 1 & 10 & D \\
		112 & The system shall be capable of being assembled by hand using basic soldering tools & 0.8 & 8 & D \\
		\hline
	\end{tabular}
	\caption{Thetis threshold capabilities organized in a traceability matrix without the verification and validation fields present.}
...
\begin{table}[ht!]
	...
	\begin{tabular}{| c | m{0.55\textwidth} | c | c | c |}
		...
		\textbf{ID} & \multicolumn{1}{c|}{\textbf{Description}} & \textbf{Weight} & \textbf{Priority} & \textbf{Status} \\
		\hline
		201 & The system shall integrate a GPS for position tracking at least 1 Hz & 0.7 & 6 & D \\
		...
		204 & The system will have configurable settings that can be set by the user & 0.4 & 3 & D \\
		...
		\hline
	\end{tabular}
	\caption{Thetis reach capabilities organized in a traceability matrix without the verification and validation fields present.}
...
\begin{table}[ht!]
	...
	\begin{tabular}{| c | m{0.55\textwidth} | c | c | c |}
		...
		\textbf{ID} & \multicolumn{1}{c|}{\textbf{Description}} & \textbf{Weight} & \textbf{Priority} & \textbf{Status} \\
		\hline
		301 & The system file storage shall be accessible via web interface	& 0.1 & 0.8 & A \\
		302 & The system shall have a backup storage option in case primary storage fails & 0.1 & 0.8 & R \\
		303 & The system will use a microcontroller capable of basic machine learning & 0.05 & 0.4 & UR \\
		304 & The system shall be able to log in a burst mode for up to 24 hours & 0.05 & 0.4 & UR \\
		\hline
	\end{tabular}
	\caption{Thetis stretch capabilities organized in a traceability matrix without the verification and validation fields present.}
