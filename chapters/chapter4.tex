...
\begin{figure}[h!]
    ...
    \label{fig:calibration_cube_machine}
\end{figure}
...
\begin{figure}
    ...
    \label{fig:raw_accel_data}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{calibration/prelim/prelim_accel.png}
    \caption[Cummulative Gyroscope Error]{Root-Mean-Square-Error during calibration across all axes and test orientations. From left to right, Thetis with respect to the ground truth, Thetis with respect to the x-IMU3, and the x-IMU3 with respect to the ground truth.}
    \label{fig:prelim_accel_data}
\end{figure}
